import{a as l,b as E}from"./vendor-f89adc3e.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&e(n)}).observe(document,{childList:!0,subtree:!0});function s(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerpolicy&&(r.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?r.credentials="include":a.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function e(a){if(a.ep)return;a.ep=!0;const r=s(a);fetch(a.href,r)}})();const _={_baseURL:"https://food-boutique.b.goit.study/api",_categoriesURL:"/products/categories",_productsURL:"/products",_popularURL:"/products/popular",_discountURL:"/products/discount",_subscriptionURL:"/subscription",_orderURL:"/orders",categories:async function(){try{return(await l.get(this._baseURL+this._categoriesURL)).data}catch(t){throw t}},popular:async function(){try{return(await l.get(this._baseURL+this._popularURL)).data}catch(t){throw t}},discount:async function(){try{return(await l.get(this._baseURL+this._discountURL)).data}catch(t){throw t}},product:async function(t){try{return(await l.get(this._baseURL+this._productsURL+`/${t}`)).data}catch(s){throw s}},products:async function(t={}){try{const s={params:t};return(await l.get(this._baseURL+this._productsURL,s)).data}catch(s){throw s}},subscribe:async function(t){try{const s={email:t};return await l.post(this._baseURL+this._subscriptionURL,s)}catch(s){throw s}},order:async function(t){try{return(await l.post(this._baseURL+this._orderURL,t)).data}catch(s){throw s}}};class p{constructor(){const t=document.querySelectorAll(".js-object");for(let s=0;s<t.length;s++)"dataset"in t[s]&&"jsname"in t[s].dataset&&(this[t[s].dataset.jsname]=t[s])}refresh(){for(var t in this)t in this&&delete this[t];const s=document.querySelectorAll(".js-object");for(let e=0;e<s.length;e++)"dataset"in s[e]&&"jsname"in s[e].dataset&&(this[s[e].dataset.jsname]=s[e])}}function S(o,t){const s=E.create(o,{onShow:a=>{document.addEventListener("keydown",e),a.element().querySelector(t).onclick=a.close},onClose:()=>{document.removeEventListener("keydown",e)}});function e(a){a.key==="Escape"&&s.close()}s.show()}const U="/js_95_Skw1/assets/icons-5c405266.svg#close-icon",R="/js_95_Skw1/assets/icons-5c405266.svg#shopping-cart-icon";async function M(o,t){const e=o.target.closest(t).dataset.productid,{name:a,desc:r,img:n,category:h,price:c,size:f,popularity:k}=await _.product(e);let w="Add to",y=i.loadCart();"products"in y&&y.products.findIndex(m=>m.productId===e)!==-1&&(w="Remove from");const C=`<div class="container">
  <div class="modal-product">
      ...
      <div class="modal-product-top">
        ...
        <div class="modal-dscr-wrapper">
          ...
          <div class="modal-product-prop-wrap">
            ...
            <p class="modal-product-prop">
              Popularity: <span class="modal-product-prop-span">${k}</span>
            </p>       
    ...
    </div>`;S(C,".js-modal-close"),document.querySelector(".js-modal-product-cart").addEventListener("click",v=>{const m=v.target.closest(".modal-product-cart");let d=i.loadCart(),I=!0;if("products"in d){const L=d.products.findIndex(j=>j.productId===e);L!==-1&&(d.products.splice(L,1),m.querySelector(".baskettext").innerHTML="Add to",I=!1)}I&&("products"in d?d.products.push({productId:e,amount:1}):d={email:"",products:[{productId:e,amount:1}]},m.querySelector(".baskettext").innerHTML="Remove from"),i.saveCart(d)})}const D="/js_95_Skw1/assets/icons-5c405266.svg#discount-icon",b="/js_95_Skw1/assets/icons-5c405266.svg#discount-cart",g="/js_95_Skw1/assets/icons-5c405266.svg#discount-checked";async function B(){const t=new p;t.discountList.innerHTML="";const s=await _.discount(),e=[];let a=0;for(s.length<2?a=s.length:a=2;a>0;a--){let c=Math.floor(Math.random()*s.length);e.push(s[c]),s.splice(c,1)}let r=i.loadCart();const n=[];"products"in r&&(r=r.products,r.forEach(c=>n.push(c.productId)));const h=[];e.forEach(c=>{let f=b;n.includes(c._id)&&(f=g),h.push(`
      ...
      </div>`,u.open()})}export{u as M,P as a,x as b,U as c,O as d,b as e,_ as f,M as g,g as h,B as i,F as j,i as l,H as p,p as r};
//# sourceMappingURL=footer-modal-80a06150.js.map
